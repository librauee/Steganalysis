function [stego, Ps] = S_UNIWARD(cover, payload, sgm)
% -------------------------------------------------------------------------
...
% the publication [1].
% This particular version of the simulator was slightly edited to accept
% custom values of the stabilization constant sigma and to output also the
% matrix of embedding probabilities for each pixel.
% -------------------------------------------------------------------------
% Input:  coverPath ... path to the image
%         payload ..... payload in bits per pixel
%         sgm ......... stabilization constant          
% Output: stego ....... resulting image with embedded payload
%         Ps .......... matrix of embedding probabilities for each pixel
% -------------------------------------------------------------------------
% [1] Digital Image Steganography Using Universal Distortion, V. Holub and
...
%% Embedding simulator
[stego, Ps] = EmbeddingSimulator(cover, rhoP1, rhoM1, payload*numel(cover), false);
...
function [y, Ps] = EmbeddingSimulator(x, rhoP1, rhoM1, m, fixEmbeddingChanges)
